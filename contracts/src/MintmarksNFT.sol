...
/**
 * @title MintmarksNFT
 * @notice Proof-of-attendance NFT system using ERC1155 and UltraHonk ZK proofs
 * @dev Each Luma event becomes an NFT collection, minted by verified attendees
 */
contract MintmarksNFT is ERC1155, Ownable {
    // ============ Errors ============
    ...
    /**
     * @notice Initialize the MintmarksNFT contract
    ...
    /**
     * @notice Mint NFT by verifying proof of attendance
