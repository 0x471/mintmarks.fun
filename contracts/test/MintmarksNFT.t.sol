...
contract MintmarksNFTTest is Test {
    ...
    function testInitialState() public view {
        ...
        assertEq(nft.collectionCreationFee(), 0.01 ether);
        assertEq(nft.mintingFee(), 0.001 ether);
    ...
    function testMintExistingCollection() public {
        ...
        vm.prank(user2);
        uint256 tokenId2 = nft.mint{value: 0.001 ether}(mockProof, mockPublicInputs);
    ...
    function testRevertInvalidPublicInputsLength() public {
        ...
        vm.expectRevert(MintmarksNFT.InvalidPublicInputs.selector);
        nft.mint{value: 0.011 ether}(mockProof, invalidInputs);
    }
    ...
    function testRevertAlreadyClaimed() public {
        ...
        // First mint succeeds
        nft.mint{value: 0.011 ether}(mockProof, mockPublicInputs);
    ...
    function testRevertInvalidProof() public {
        ...
        vm.expectRevert(MintmarksNFT.InvalidProof.selector);
        nft.mint{value: 0.011 ether}(mockProof, mockPublicInputs);
    }
    ...
    function testRevertInsufficientFeeNewCollection() public {
        ...
        vm.expectRevert(MintmarksNFT.InsufficientFee.selector);
        nft.mint{value: 0.001 ether}(mockProof, mockPublicInputs); // Only minting fee
    }
    ...
    function testRevertInsufficientFeeExistingCollection() public {
        ...
        vm.expectRevert(MintmarksNFT.InsufficientMintingFee.selector);
        nft.mint{value: 0.0001 ether}(mockProof, mockPublicInputs);
    }

    function testSetCollectionCreationFee() public {
        vm.prank(owner);
        nft.setCollectionCreationFee(0.02 ether);

        assertEq(nft.collectionCreationFee(), 0.02 ether);
    }

    function testSetMintingFee() public {
        vm.prank(owner);
        nft.setMintingFee(0.002 ether);

        assertEq(nft.mintingFee(), 0.002 ether);
    }
